...
class ekf_mfClass {
 ...
 public:
  ...
  void step(const real_T arg_dists[4], real_T arg_deltat, real_T arg_imu,
            uint8_T arg_nodeId, real_T arg_x_est[6], real_T arg_calibEnable,
 ...
 private:
  // Real-Time Model
  RT_MODEL_ekf_mf_T ekf_mf_M;

  // private member function(s) for subsystem '<Root>'
  void ekf_mf_eml_sort(const real_T x_data[], const int32_T x_sizes[2], real_T
